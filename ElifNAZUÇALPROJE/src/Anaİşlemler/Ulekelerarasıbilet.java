...
import Bilet.YurtDısıBilet;
import GirisEkranı.GirisEkranı;
import com.toedter.calendar.JDateChooser;

public class Ulekelerarasıbilet extends JFrame {
	...
	private JDateChooser dateelif = new JDateChooser();
	 ...
	 public Ulekelerarasıbilet(String id) {

		 //comboboxları txt den okuma  /////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 dosya2 = new File("yurtdısıhava.txt");
		 ...
		 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			this.setTitle("Ülkeler Arası Biletler...");
		 ...
		 this.getContentPane().add(ok);
			...
			JLabel lblNewLabel_1 = new JLabel("Ülkeler Arası Bilet Al");
			...
			JComboBox comboBox = new JComboBox(ulkeler);
			...
			JComboBox comboBox_1 = new JComboBox(ulkeler);
			...
			dateelif.setBounds(784, 544, 296, 30);
			this.getContentPane().add(dateelif);
	        ...
	        buton1.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                if(e.getSource()==buton1) {
						...
						boolean bosluklar = false;
						boolean sehirici = false;
						boolean aynı= false;
						boolean tarihoncemi = false;
						Date bugun = new Date();
						SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
						String strbugun = formatter.format(bugun);
						String strelif = formatter.format(dateelif.getDate());

						if(dateelif.getDate().before(bugun)){
						tarihoncemi = true;
						}
						if(strbugun.equals(strelif)){
	                	  ...
	                	  if (textField.getText().isEmpty()  || textField_1.getText().isEmpty() ||  dateelif.isValid()) {
	                	  ...
	                	  if ((textField.getText().equals("Ankara")&&textField_1.getText().equals("İstanbul"))||(textField.getText().equals("İstanbul")&&textField_1.getText().equals("Ankara"))){
							  JOptionPane.showMessageDialog(null, "Bu Bilet Alışverişi İçin Yurtiçi Biletleri Tercih Edin !");
							  sehirici = true;
						  }
	                   ...
	                   if(((bulundumu==false) && (sehirici==false)) && ((aynı==false) && (bosluklar==false) && (tarihoncemi == false))) {
